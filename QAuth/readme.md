...
这份文档汇集了 **Minecraft 插件 (QAuth v1.3)** 和 **Nonebot2 机器人** 的所有功能、指令及配置说明。
...
| 平台 | 版本 | 文件 |
|------|------|------|
| Bukkit/Spigot/Paper | 1.21+ | `QAuth.jar` |
| Fabric | 1.20.1 | `qauth-fabric-1.3.jar` |
...
*   说明 Java 插件版本过低，不支持机器人发送的指令。请重新打包上传最新版 (v1.3) 的 `QAuth.jar` 并重启服务器。
